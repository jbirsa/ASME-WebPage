      ...
      <div className="max-w-6xl mx-auto">
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-300">
            Empresas que confían en nuestro proyecto y apoyan la excelencia en
            ingeniería
          </p>
        </div>
        ...
        {/* First row of logos */}
        <div
          className={`flex space-x-20 items-center justify-center mb-8 ${
        ...
        >
          {renderSponsorSets(sponsors.slice().reverse(), [
            "reverse",
            "reverse-duplicate-1",
            "reverse-duplicate-2",
            "reverse-duplicate-3",
